        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          >
            ...
            <div className="w-12 h-12 rounded-full bg-success/20 flex items-center justify-center relative">
              <QrCode className="h-7 w-7 transition-transform group-hover:scale-125 text-success relative z-10" />
            </div>
            <span className="text-sm font-bold relative z-10">Escanear Clínica</span>
          </Button>
          <Button 
            variant="outline" 
            size="lg" 
